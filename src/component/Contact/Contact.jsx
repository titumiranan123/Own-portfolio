    ...
    return (
        ...
        <div className="group w-full mx-auto py-8 px-4 sm:px-6   lg:hover:!opacity-100 lg:group-hover/list:opacity-50">
            <div className="relative bg-slate-900 overflow-hidden shadow-sm sm:rounded-lg">
                <div className="absolute -inset-x-4 -inset-y-4 z-0 hidden py-auto px-auto rounded-md transition motion-reduce:transition-none lg:-inset-x-6 lg:block lg:group-hover:bg-slate-800/50 lg:group-hover:shadow-[inset_0_1px_0_0_rgba(148,163,184,0.1)] lg:group-hover:drop-shadow-lg">

                </div>
                <div className="w-full p-6bg-slate-900">
                    <FaTelegramPlane />
                    <h2 className="text-2xl  font-bold mb-4 text-slate-400">GET In TOUCH</h2>
                    <form className="flex flex-col gap-2" ref={form} onSubmit={handleSubmit}>
                        ...
                        <textarea
                            ...
                            name="message" />
                        <input className="bg-teal-400 text-white font-bold py-2 px-4 rounded"
